...
Esta seção reúne os fundamentos da marca Fab Lab Joinville: posicionamento, tom de voz, identidade visual, cores, tipografia, ícones e critérios mínimos de acessibilidade.
...
O Fab Lab busca resolver, em um âmbito sociocultural, a desigualdade, a ineficiência dos sistemas e a ignorância.

### Princípios

As pessoas que fazem parte do Fab Lab acreditam em respeito à diversidade, no método científico como fonte de aprendizado e na colaboração entre diferentes áreas de conhecimento para a construção de uma comunidade forte.
...
Ao participar ativamente do Fab Lab, você irá colaborar e contribuir com diferentes pessoas e grupos através do aprendizado, do ensino e do desenvolvimento de soluções para problemas.

O Fab Lab promove a disseminação de conhecimento, engajando pessoas dispostas a se conectar e promover eventos que estimulam o aprendizado.
